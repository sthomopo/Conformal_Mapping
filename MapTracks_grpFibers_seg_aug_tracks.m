...
%trk_dir= strcat(data_dir, '/Trk_2_Cell/Resampled_augmented_convol/');
...
%% Map tracks 
output_dir_map=strcat(data_dir, 'Mapped_tracks_Segmented_Aug_Convol') %changed output_dir to output_dir_map
